...
return [
    ...
    'configRepository' => \ali\User\Repositories\TestConfigRepo::class,
    ...
    'aclRepository' => \ali\User\Repositories\UsersACLRepo::class,
     ...
     * [] - no restrictions
     */
    'allowFileTypes' => ['zip', 'rar', 'png', 'jpg', 'jpeg', 'mp4', 'webp'],
    ...
    'aclRules' => [
        ...
        2 => [
//            ['disk' => 'private', 'path' => '*', 'access' => 2],        // don't have access
//            ['disk' => 'private', 'path' => 'users', 'access' => 2],

//            ['disk' => 'private', 'path' => '/', 'access' => 2],
//            ['disk' => 'private', 'path' => 'teacherCourse/' . auth()->user(), 'access' => 2],
