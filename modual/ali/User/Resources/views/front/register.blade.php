    ...
    <form action="" class="form" method="post">
        ...
        <div class="form-content form-account">
            <form method="POST" action="{{ route('register') }}">
                ...
                <input style="direction: ltr" id="mobile" type="text"
                ...
                <input style="direction: ltr" id="password" type="password"
                       class="txt txt-l @error('password') is-invalid @enderror"
                       placeholder="رمز عبور *"
                       name="password" required autocomplete="new-password"
                >
                <input style="direction: ltr" id="password-confirm" type="password"
                       class="txt txt-l @error('password') is-invalid @enderror"
                       placeholder="تایید رمز عبور *"
                       name="password_confirmation" required autocomplete="new-password"
                >
                <span class="rules">رمز عبور باید حداقل ۶ کاراکتر  باشد.</span>
                @error('password')
                <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
